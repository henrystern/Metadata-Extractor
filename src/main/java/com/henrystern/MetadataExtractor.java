        ...
        runButton.addActionListener(ae -> {
            ...
            if (PDF_List.length > 0) {
                ...
                try {
                    ...
                    printJournal("Unknown error while generating csv - Likely ran out of memory - try separating your files into 100/% smaller batches");
                    throw new RuntimeException(e);
                }
        ...
        for (String PDF : PDF_List) {
            ...
            if (output_requested) {
                ...
                for (int item = 0; item < 7; item++) {
                    ...
                    if (item == 0) {
                        contentStream.showText(Metadata_Array[0][item] + ": " + PDF);
                        ...
                        contentStream.showText(Metadata_Array[0][item] + ":  " + PDF_Metadata[i][item]);
                    }
